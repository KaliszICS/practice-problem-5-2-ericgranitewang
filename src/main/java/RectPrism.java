public class RectPrism extends Rectangle {
    ...
    public RectPrism(int length, int width, int height) {
        ...
        // this.width = width;
        this.height = height;
        //length -> local variable (the one that was created in this method/constrcutor)
        //length -> this.length -> instance variable
        //length -> super.length -> superclasses instance variable
    }
